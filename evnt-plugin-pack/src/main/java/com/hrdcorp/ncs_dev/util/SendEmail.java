...
public class SendEmail {
    ...
    public static void sendEmail(String plugin_name, String user_email, String bcc, String subject, String msg) {  
        ...
        LogUtil.info("HRDC - EVENT - "+ plugin_name +" ---->"," Send Email Util: Actually Sending Email to: " +user_email);
        ...
        try{
            ...
            LogUtil.error("HRDC - EVENT - "+ plugin_name +" ---->", ex, "Error sending email");
        }
        
        LogUtil.info("HRDC - EVENT - "+ plugin_name +" ---->","Email successfully sent to participant: " + user_email);      
    }
