...
public class EvntEmailTemplateMapper extends DefaultApplicationPlugin{
    
    @Override
    public String getName() {
        return ("HRDC - EVENT - Email Template Mapper");
    }
    ...
    public Object execute(Map props){
        ...
        if ((to_pt_id != null && to_pt_id.trim().length() != 0) || (to != null && to.trim().length() != 0)) {
            ...
            LogUtil.info("HRDC - EVENT - Email Template Mapper Plugin ---->","Email not found");
        }
        ...
        if ((cc_pt_id != null && cc_pt_id.trim().length() != 0) || (cc != null && cc.trim().length() != 0)) {
            ...
            LogUtil.info("HRDC - EVENT - Email Template Mapper Plugin ---->","CC not specified");
        }
        ...
        try(Connection con = ds.getConnection();) {
            ...
            LogUtil.info("HRDC - EVENT - Email Template Mapper Plugin ---->","Non-template?: " + non_template_setup);

            if(non_template_setup.equals("true")){
                LogUtil.info("HRDC - EVENT - Email Template Mapper Plugin ---->","Non-template email: " + id);
                ...
                LogUtil.info("HRDC - EVENT - Email Template Mapper Plugin ---->","Template email: " + id);
            ...
            // LogUtil.info("HRDC - EVENT - Email Template Mapper Plugin ---->","Receiver: " + receiver);
