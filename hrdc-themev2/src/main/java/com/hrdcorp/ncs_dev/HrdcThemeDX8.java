 ...
 * @author farih
 */
public class HrdcThemeDX8 extends AjaxUniversalTheme{
    
    @Override
    public String getName() {
        return "HRDC Theme DX8";
    }
    ...
    public String getJsCssLib(Map<String, Object> data) {
        ...
        cssJs += "<link href='https://fonts.googleapis.com/css?family=Montserrat rel='stylesheet'>";
